...
public class Reinformation implements Serializable{
	...
	private int reSubordinates;
//	private int eid;
	private EnterpriseInfo e;	// ∂‘œÛ Ù–‘
	...
	public Reinformation(String rePositionName, String reSalary, String reCity, String reArea, String reWorkYears,
			String reEducation, int rePersonNum, String reLightPoint, String reJobDesc, String reDepartment,
			String reProfessional, String reReportPerson, int reSubordinates, EnterpriseInfo e) {
		super();
	...
	public Reinformation(Integer reid, String rePositionName, String reSalary, String reCity, String reArea,
			String reWorkYears, String reEducation, int rePersonNum, String reLightPoint, String reJobDesc,
			String reDepartment, String reProfessional, String reReportPerson, int reSubordinates, EnterpriseInfo e) {
		super();
		this.reid = reid;
		this.rePositionName = rePositionName;
		this.reSalary = reSalary;
	...
	public int getRePersonNum() {
		return rePersonNum;
	}
	public void setRePersonNum(int rePersonNum) {
		this.rePersonNum = rePersonNum;
	}
	...
	public int getReSubordinates() {
		return reSubordinates;
	}
	public void setReSubordinates(int reSubordinates) {
		this.reSubordinates = reSubordinates;
	}
