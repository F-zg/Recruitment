...
/**
 * Servlet implementation class ListEnterpriseInfoServlet
 */
@WebServlet("/listEnterpriseInfoServlet")
public class ListEnterpriseInfoServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("showAllEnterpriseInfo.jsp").forward(request, response);
	}
