...
/**
 * Servlet implementation class GetAllReinformationsServlet
 */
@WebServlet("/GetAllReinformationsServlet")
public class GetAllReinformationsServlet extends HttpServlet {
     ...
     */
    public GetAllReinformationsServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/showAllReinformation.jsp").forward(request, response);
	}
