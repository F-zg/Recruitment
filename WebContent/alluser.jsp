		...
		<!-- header-starts -->
			...
			<!--/down-->
							<div class="down">	
									  ...
									  <a href="index.html"><span class=" name-caret">Hello Admin</span></a>
                           ...
                           <div class="menu">
									<ul id="menu" >									
										 <li id="menu-academico" ><i class="fa fa-table"></i> <span>用户信息管理</span> <span class="fa fa-angle-right" style="float: right"></span>
