																	...
																	<c:forEach items="${requestScope.userinfos}" var="item">
																		<tbody>
																			<tr>
																				...
																				<td>${item.email}</td>
																				<td>${item.address}</td>
																				<td><a class="deleteClass" href="${pageContext.request.contextPath }/freezeUserinfoServlet?userId=${item.userId}">冻结</a></td>
																				<td><a class="deleteClass" href="${pageContext.request.contextPath }/releaseUserinfoServlet?userId=${item.userId}">解锁</a></td>																				
																			</tr>
																		</tbody> 
																	</c:forEach> 
																</table>
