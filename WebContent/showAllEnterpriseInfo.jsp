...
<script>
	function delRow(id){
		if(confirm("是否确认删除？")){
			window.location.href="<%=request.getContextPath()%>/delEnterpriseInfoServlet?eid="+id;
		}
	}
	function modRow(id){
		if(confirm("是否确认修改？")){
			window.location.href="<%=request.getContextPath()%>/findByEidServlet?eid="+id;
		}
	}
</script>
<body>
									...
									<tbody>
										<c:forEach items="${requestScope.list}" var="e">
											<tr>
												...
												<td>${e.intustry}</td>
												<td><button onclick="modRow(${e.eid})">修改</button>
													<button onclick="delRow(${e.eid})">删除</button></td>
											</tr>
										</c:forEach>
									</tbody>
								</table>
			...
			<div class="menu">
				<ul id="menu">
					...
					<li id="menu-academico"><a href="#"><i class="fa fa-table"></i>
							<span>企业管理</span> <span class="fa fa-angle-right"
							style="float: right"></span></a>
						<ul id="menu-academico-sub">
							<li id="menu-academico-boletim"><a href="showPageEnterpriseInfo.jsp">企业信息管理</a></li>
						</ul></li>
					<li id="menu-academico"><a href="#"><i
							class="fa fa-file-text-o"></i> <span>会员管理</span> <span
