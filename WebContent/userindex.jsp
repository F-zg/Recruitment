	   ...
	   <div class="inner-content">
		<!-- header-starts -->
												...
												<!--/candile-->
													<div class="candile"> 
															<div class="candile-inner">
																	<h3 class="sub-tittle">欢迎访问人才招聘管理系统</h3>
															    <div id="center">
															    <div id="fig">														
			...
			<!--/down-->
                           ...
                           <div class="menu">
									<ul id="menu" >
										 <li id="menu-academico" ><a href="#"><i class="fa fa-file-text-o"></i> <span>用户信息</span> <span class="fa fa-angle-right" style="float: right"></span></a>
											 <ul id="menu-academico-sub" >
												<li id="menu-academico-boletim" ><a href="${pageContext.request.contextPath }/displayUserinfoServlet">显示用户信息</a></li>
												<li id="menu-academico-boletim" ><a href="${pageContext.request.contextPath }/displayUserinfoServlet?method="post">修改用户信息</a></li>
											  </ul>
										 </li>
										 <li id="menu-academico" ><a href="#"><i class="fa fa-file-text-o"></i> <span>简历管理</span> <span class="fa fa-angle-right" style="float: right"></span></a>
											 <ul id="menu-academico-sub" >
												<li id="menu-academico-boletim" ><a href="${pageContext.request.contextPath }/showResumeServlet">查看简历</a></li>
												<li id="menu-academico-boletim" ><a href="updateResume.jsp">修改简历</a></li>
												<li id="menu-academico-boletim" ><a href="addResume.jsp">增加简历</a></li>
											
											  </ul>
										 </li>					        
									 <li id="menu-academico" ><a href="#"><i class="fa fa-table"></i> <span>企业资讯</span> <span class="fa fa-angle-right" style="float: right"></span></a>
										   <ul id="menu-academico-sub" >
												<li id="menu-academico-boletim" ><a href="${pageContext.request.contextPath }/ListEnterpriseInfoforUserServlet">企业信息查看</a></li>
											</ul>
										</li>
										 <li id="menu-academico" ><a href="#"><i class="fa fa-table"></i> <span>岗位资讯</span> <span class="fa fa-angle-right" style="float: right"></span></a>
										   <ul id="menu-academico-sub" >
												<li id="menu-academico-boletim" ><a href="${pageContext.request.contextPath }/ShowAllReinformationForUser">岗位信息查看</a></li>
											</ul>
										</li>
