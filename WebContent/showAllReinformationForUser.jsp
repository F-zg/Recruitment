			...
			<div class="inner-content">
				...
				<div class="outter-wp">
					...
					<div class="graph-visual tables-main">
						<h3 class="inner-tittle two">全部岗位信息</h3>
									...
									<tbody>
										...
										<c:forEach items="${requestScope.Reinformationlist}" var="item">
											<tr>
												...
												<td><a
													href="${pageContext.request.contextPath }/GetReinformationByIdServlet2?reid=${item.reid}">查看</a></td>
<%-- 												<td><a href="${pageContext.request.contextPath }/GetReinformationByIdServlet?reid=${item.reid}">查看</a></td>
												<td><a
