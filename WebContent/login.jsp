								...
								<!--/login-->								
									   <div class="error_page">
												<!--/login-top-->
													...
													<div class="error-top">
													<h2 class="inner-tittle page">用户登录</h2>
													    <div class="login">
														<h3 class="inner-tittle t-inner">Login</h3>												
																<form action="loginServlet" method="post">
																		...
																		<div class="new">
																			<p class="sign">Do not have an account ? <a href="regUser.jsp">Sign Up</a></p>
										...
										<div class="footer">
										   ...
										   <p>Copyright &copy; 2021.Chinasofti International All rights reserved.</p>
										</div>
									<!--footer section end-->
									<!--/404-->
<!--js -->
