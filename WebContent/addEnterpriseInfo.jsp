			...
			<div class="inner-content">
				...
				<div class="outter-wp">
					...
					<div class="graph-visual tables-main">
						<form
							action="${pageContext.request.contextPath }/addEnterpriseInfoServlet"
							method="post">
							<div class="form-group">
								<label for="exampleInputEmail1">企业名称</label> <input type="text"
									class="form-control" id="ename" name="ename" placeholder="企业名称">
							</div>
							<div class="form-group">
								<label for="exampleInputPassword1">企业介绍</label>

								<textarea class="form-control" id="eintro" placeholder="企业介绍"
									name="eintro">企业介绍</textarea>
