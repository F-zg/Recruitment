			...
			<div class="inner-content">
				...
				<div class="outter-wp">
					...
					<div class="graph-visual tables-main">
						<form action="${pageContext.request.contextPath }/modifyEnterpriseInfoServlet" method="post">
							<div class="form-group">
								<input type="hidden" name="eid"
									value="${requestScope.enterpriseInfo.eid}">
							</div>
							<p>${requestScope.enterpriseInfo.eid}</p>
							<div class="form-group">
								<label for="exampleInputEmail1">企业名称</label> <input type="text"
									class="form-control" id="ename" name="ename"
									value="${requestScope.enterpriseInfo.ename}">
							</div>
							<div class="form-group">
								<label for="exampleInputPassword1">企业介绍</label>

								<textarea class="form-control" id="eintro" 
									name="eintro" value="${requestScope.enterpriseInfo.eintro}">企业介绍</textarea>
							</div>
							<div class="form-group">
								<label for="exampleInputFile">所属类别</label> <input type="text"
									id="intustry" name="intustry"
									value="${requestScope.enterpriseInfo.intustry}">
							</div>
					...
					<div class="menu">
						<ul id="menu">
							...
							<li id="menu-academico"><a href="#"><i
									class="fa fa-table"></i> <span>企业管理</span> <span
